package # hidden from cpan
    Nagios::Generator::TestConfig::InitScriptData;
...
sub get_init_script {
    ...
    $initscript =~ s/__NAGIOSBIN__/$nagiosbin/gmx;
...
prefix=__PREFIX__
NagiosBin=__NAGIOSBIN__
NagiosCfgFile=${prefix}/nagios.cfg
NagiosStatusFile=${prefix}/var/status.dat
NagiosRetentionFile=${prefix}/var/retention.dat
NagiosCommandFile=${prefix}/var/rw/nagios.cmd
NagiosVarDir=${prefix}/var
NagiosRunFile=${prefix}/var/nagios3.pid
NagiosLockDir=${prefix}/var/
NagiosLockFile=nagios.pid
NagiosUser=__USER__
NagiosGroup=__GROUP__
